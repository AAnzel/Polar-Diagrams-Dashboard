...
layout_first_row = dbc.Row(
    [
        dbc.Col(
            [
                dbc.Button(
                    class_name="fa-solid fa-bars fa-5x",
                    id="open_offcanvas",
                    n_clicks=0,
                    color="light",
                ),
                dbc.Offcanvas(
                    [
                        ...
                        dbc.Row(
                            [
                                dbc.Col(
                                    html.H4("Source Code and Data"), width=8
                                ),
                                dbc.Col(
                                    html.A(
                                        html.I(
                        ...
                        html.P(
                            [
                                "Anžel, A., Heider, D., & Hattab, G. (2023). "
                        ...
                        html.P(
                            [
                                ...
                                html.A(
                                    "CLIVAR Exchanges Newsletter, No. 56, Vol. 15, No. 2",
                                    href="http://www.clivar.org/publications/exchanges/Exchanges_56.pdf?id=45",
                                    target="_blank",
                                    style={"color": "inherit"},
                                ),
                                html.Br(),
                                ...
                                html.A(
                                    ...
                                    href="http://www.clivar.org/organization/wgcm/wgcm-10/Aspen_WhitePaper_1final.pdf?id=42",
                                    target="_blank",
                                    style={"color": "inherit"},
                                ),
                                " WCRP Informal "
                        ...
                        html.P(
                            [
                                ...
                                html.A(
                                    ...
                                    href="https://dl.acm.org/doi/10.5555/645631.662879",
                                    target="_blank",
                                    style={"color": "inherit"},
                                ),
                            ],
                        ...
                        html.P(
                            [
                                "Yang, Z., Dai, X., Dubey, A., Hirche, S., & Hattab,"
                    ...
                    id="offcanvas",
                    title=html.H2(
                        "Summary Polar Diagrams Dashboard",
...
dash_app.layout = dbc.Container(
    [
        layout_first_row,
        dbc.Row(className="g-0", justify="center", id="row_main_content"),
    ],
    fluid=True,
)
...
def display_main_content(string_button_value):
    if string_button_value == "climate":
        return (
            overview_detail._layout_return(0),
            "Case Study - Climate",
            "taylor",
        )
    elif string_button_value == "wine":
        return (
            overview_detail._layout_return(1),
            "Case Study - Wine",
            "mid scaled",
        )  # Default value on initial view
    elif string_button_value == "ml":
        return (
            overview_detail._layout_return(2),
...
@callback(
    ...
    [Input("open_offcanvas", "n_clicks"), Input("radio_button", "value")],
